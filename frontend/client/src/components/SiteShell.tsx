...
export function SiteShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen overflow-x-clip bg-[#fcfaf6]">
    <div className="border-b border-[#eadfca] bg-[#244c3d] px-5 py-2.5 text-center text-[10px] font-bold tracking-[0.12em] text-[#fffaf0] sm:text-xs">CARE, CONNECTED — WITH TRUST</div>
    ...
    <footer className="border-t border-[#e7dcc7] bg-white"><div className="container grid gap-10 py-12 md:grid-cols-[1.25fr_.75fr_.75fr]">
      <div><BrandMark /><p className="mt-5 max-w-sm text-sm leading-7 text-[#617064]">A connected veterinary care network for animal owners, professionals, clinics, and accountable vendors.</p></div>
    ...
    </div><div className="border-t border-[#eee4d2]"><div className="container flex flex-col gap-2 py-4 text-xs font-medium text-[#788179] sm:flex-row sm:justify-between"><span>© 2026 VetKonnect</span><span>Privacy · Terms · Clinical safety</span></div></div></footer>
  </div>;
}
